...
playerTurn playerHand dealerHand deck = do
    ...
    else if handValue playerHand > 21 then do
...
playRound playerHand dealerHand deck = do
    if handValue playerHand == 21 && handValue dealerHand == 21 then
        putStrLn "Both you and the dealer have Blackjack! It's a tie!"
    else if handValue playerHand == 21 then
        putStrLn "Blackjack! You win!"
    else if handValue dealerHand == 21 then
